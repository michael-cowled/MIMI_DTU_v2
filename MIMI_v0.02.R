MIMI <- function() {           
    ...
    while (Matrix_Row_No <= Matrix_TotalRows) {
        ...
        while (i < n+1) {
            ...
            if (Coculture$RetTime[i] < CON1$RetTime[z] + 0.1 && Coculture$RetTime[i] > CON1$RetTime[z] - 0.1 && FinalCount > 0) {  
        ...
        while (i < n+1) {
            ...
            if (Coculture$RetTime[i] < CON2$RetTime[z] + 0.1 && Coculture$RetTime[i] > CON2$RetTime[z] - 0.1 && FinalCount > 0) {  
